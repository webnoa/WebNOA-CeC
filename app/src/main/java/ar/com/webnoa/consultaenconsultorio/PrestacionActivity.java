...
public class PrestacionActivity extends AppCompatActivity {
    ...
    //String pNroAfiliadoTemp,pCdsTemp;
        ...
        validarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(pass) || pass.length() < 11)
                {
                    ...
                    //toast = Toast.makeText(getApplicationContext(), "Nro Afiliado, No puede ser menor o mayor, a 11 digitos", Toast.LENGTH_LONG);
                    //toast.show();
                    ...
                    //pNroAfiliadoTemp = nroAfiliadoTxt.getText().toString();
                    //pCdsTemp = cdsTxt.getText().toString();
                    PrestacionXml prestacionXML = new PrestacionXml(PrestacionActivity.this,nroAfiliadoTxt,cdsTxt,resultadoTxt,avisoTxt);
                    //PrestacionXml prestacionXML= new PrestacionXml(PrestacionActivity.this,resultadoTxt,pNroAfiliadoTemp,pCdsTemp);
